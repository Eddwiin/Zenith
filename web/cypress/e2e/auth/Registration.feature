...
Feature: Zenith - Registration
    ...
    Scenario Outline: Successful & Unsucessful registration
        ...
        Examples:
            ...
            | John      | Doe      | john.doetest.fr      | Azerty123! | Azerty123!           | /registration | The email is invalid                                                                                                |            |
            | John      | Doe      | john.doe@test        | Azerty123! | Azerty123!           | /registration | The email is invalid                                                                                                |            |
